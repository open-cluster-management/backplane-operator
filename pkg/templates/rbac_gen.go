...
//+kubebuilder:rbac:groups=addons.cluster.x-k8s.io,resources=*,verbs=create;delete;get;list;patch;update;watch
...
//+kubebuilder:rbac:groups=bootstrap.cluster.x-k8s.io;infrastructure.cluster.x-k8s.io,resources=*,verbs=create;delete;get;list;patch;update;watch
...
//+kubebuilder:rbac:groups=cert-manager.io,resources=issuers,verbs=create;delete;get;list;patch;update;watch
...
//+kubebuilder:rbac:groups=cluster.x-k8s.io,resources=clusters;clusters/status,verbs=get;list;patch;update;watch
//+kubebuilder:rbac:groups=cluster.x-k8s.io,resources=clusters;clusters/status,verbs=get;list;watch
//+kubebuilder:rbac:groups=cluster.x-k8s.io,resources=clusters;machinepools;machines,verbs=get;list;watch
...
//+kubebuilder:rbac:groups=cluster.x-k8s.io,resources=machinedeployments;machinedeployments/finalizers,verbs=get;list;patch;update;watch
//+kubebuilder:rbac:groups=cluster.x-k8s.io,resources=machinedeployments;machinedeployments/finalizers;machinedeployments/status,verbs=create;delete;get;list;patch;update;watch
//+kubebuilder:rbac:groups=cluster.x-k8s.io,resources=machinehealthchecks,verbs=create;delete;get;list;patch;update;watch
//+kubebuilder:rbac:groups=cluster.x-k8s.io,resources=machinehealthchecks;machinehealthchecks/finalizers;machinehealthchecks/status,verbs=get;list;patch;update;watch
//+kubebuilder:rbac:groups=cluster.x-k8s.io,resources=machinepools,verbs=create;delete;get;list;patch;update;watch
//+kubebuilder:rbac:groups=cluster.x-k8s.io,resources=machinepools,verbs=get;list;watch
//+kubebuilder:rbac:groups=cluster.x-k8s.io,resources=machinepools;machinepools/finalizers;machinepools/status,verbs=create;delete;get;list;patch;update;watch
//+kubebuilder:rbac:groups=cluster.x-k8s.io,resources=machinepools;machinepools/status,verbs=get;list;patch;watch
//+kubebuilder:rbac:groups=cluster.x-k8s.io,resources=machines;machines/finalizers;machines/status,verbs=create;delete;get;list;patch;update;watch
...
//+kubebuilder:rbac:groups=cluster.x-k8s.io,resources=machinesets;machinesets/finalizers,verbs=get;list;patch;update;watch
//+kubebuilder:rbac:groups=cluster.x-k8s.io,resources=machinesets;machinesets/finalizers;machinesets/status,verbs=create;delete;get;list;patch;update;watch
...
//+kubebuilder:rbac:groups=controlplane.cluster.x-k8s.io,resources=awsmanagedcontrolplanes,verbs=delete;get;list;patch;update;watch
//+kubebuilder:rbac:groups=controlplane.cluster.x-k8s.io,resources=awsmanagedcontrolplanes/status,verbs=get;patch;update
...
//+kubebuilder:rbac:groups=controlplane.cluster.x-k8s.io,resources=rosacontrolplanes,verbs=delete;get;list;patch;update;watch
//+kubebuilder:rbac:groups=controlplane.cluster.x-k8s.io,resources=rosacontrolplanes/finalizers,verbs=update
//+kubebuilder:rbac:groups=controlplane.cluster.x-k8s.io,resources=rosacontrolplanes/status,verbs=get;patch;update
...
//+kubebuilder:rbac:groups=infrastructure.cluster.x-k8s.io,resources=awsclustercontrolleridentities;awsclusterroleidentities;awsclusterstaticidentities,verbs=get;list;watch
...
//+kubebuilder:rbac:groups=infrastructure.cluster.x-k8s.io,resources=awsclusters,verbs=delete;get;list;patch;update;watch
//+kubebuilder:rbac:groups=infrastructure.cluster.x-k8s.io,resources=awsclusters/status,verbs=get;patch;update
//+kubebuilder:rbac:groups=infrastructure.cluster.x-k8s.io,resources=awsfargateprofiles,verbs=delete;get;list;patch;update;watch
//+kubebuilder:rbac:groups=infrastructure.cluster.x-k8s.io,resources=awsfargateprofiles/status,verbs=get;patch;update
//+kubebuilder:rbac:groups=infrastructure.cluster.x-k8s.io,resources=awsmachinepools,verbs=delete;get;list;patch;update;watch
//+kubebuilder:rbac:groups=infrastructure.cluster.x-k8s.io,resources=awsmachinepools/status,verbs=get;patch;update
...
//+kubebuilder:rbac:groups=infrastructure.cluster.x-k8s.io,resources=awsmachines,verbs=delete;get;list;patch;update;watch
//+kubebuilder:rbac:groups=infrastructure.cluster.x-k8s.io,resources=awsmachines/status,verbs=get;patch;update
...
//+kubebuilder:rbac:groups=infrastructure.cluster.x-k8s.io,resources=awsmanagedclusters,verbs=delete;get;list;patch;update;watch
//+kubebuilder:rbac:groups=infrastructure.cluster.x-k8s.io,resources=awsmanagedclusters/status,verbs=get;patch;update
...
//+kubebuilder:rbac:groups=infrastructure.cluster.x-k8s.io,resources=awsmanagedmachinepools,verbs=delete;get;list;patch;update;watch
//+kubebuilder:rbac:groups=infrastructure.cluster.x-k8s.io,resources=awsmanagedmachinepools/status,verbs=get;patch;update
...
//+kubebuilder:rbac:groups=infrastructure.cluster.x-k8s.io,resources=rosaclusters,verbs=delete;get;list;patch;update;watch
//+kubebuilder:rbac:groups=infrastructure.cluster.x-k8s.io,resources=rosaclusters/status,verbs=get;patch;update
//+kubebuilder:rbac:groups=infrastructure.cluster.x-k8s.io,resources=rosamachinepools,verbs=delete;get;list;patch;update;watch
//+kubebuilder:rbac:groups=infrastructure.cluster.x-k8s.io,resources=rosamachinepools/finalizers,verbs=update
//+kubebuilder:rbac:groups=infrastructure.cluster.x-k8s.io,resources=rosamachinepools/status,verbs=get;patch;update
